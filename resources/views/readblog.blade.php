            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    <div class="blog single mt-n17">
                        <div class="card">
                            <figure class="card-img-top"><img src="/img/photos/b1.jpg" alt="" /></figure>
                            <div class="card-body">
                                            ...
                                            <div class="row g-6 mt-3 mb-10">
                                                <div class="col-md-6">
                                                    <figure class="hover-scale rounded cursor-dark"><a
                                                            href="/img/photos/b8-full.jpg"
                                                            data-glightbox="title: Heading; description: Purus Vulputate Sem Tellus Quam"
                                                            data-gallery="post"> <img src="/img/photos/b8.jpg"
                                                                alt="" /></a></figure>
                                                </div>
                                                <!--/column -->
                                                <div class="col-md-6">
                                                    <figure class="hover-scale rounded cursor-dark"><a
                                                            href="/img/photos/b9-full.jpg" data-glightbox
                                                            data-gallery="post"> <img src="/img/photos/b9.jpg"
                                                                alt="" /></a></figure>
                                                </div>
                                                <!--/column -->
                                                <div class="col-md-6">
                                                    <figure class="hover-scale rounded cursor-dark"><a
                                                            href="/img/photos/b10-full.jpg" data-glightbox
                                                            data-gallery="post"> <img src="/img/photos/b10.jpg"
                                                                alt="" /></a></figure>
                                                </div>
                                                <!--/column -->
                                                <div class="col-md-6">
                                                    <figure class="hover-scale rounded cursor-dark"><a
                                                            href="/img/photos/b11-full.jpg" data-glightbox
                                                            data-gallery="post"> <img src="/img/photos/b11.jpg"
                                                                alt="" /></a></figure>
                                                </div>
                                                <!--/column -->
                                            </div>
