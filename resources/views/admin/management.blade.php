                                ...
                                <div class="card col-md-6">
                                    ...
                                    <div class="card-body">
                                       <div class="row">
                                        ...
                                        <div class="col  ">
                                            <img src="{{asset('images/profiles/'.$item->picture)}}" alt="" srcset=""  style="border-radius: 100px; max-height:200px;">
                                        </div>
                                        <div class="col  ">
                                            Phone: {{$item->phone}} <br>
                                            Email: {{$item->email}} <br>
                                    ...
                                    <div class="modal-content container">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form action="{{ route('updatestaff',$item->id) }}" method="post"
                                                    enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="form-group">
                                                        <label for="">Name</label>
                                                        <input type="text" name="name" value="{{$item->name}}" required id=""
                                                            class="form-control" placeholder="" aria-describedby="helpId">
                                                    </div> <br>
                                                    <div class="form-group">
                                                        <label for="">position</label>
                                                        <input type="text" name="position" required id=""
                                                            class="form-control" value="{{$item->position}}" placeholder="" aria-describedby="helpId">
                                                    </div><br>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="tel" name="phone" required id=""
                                                            class="form-control" placeholder="" value="{{$item->phone}}" aria-describedby="helpId">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="">email</label>
                                                        <input type="email" name="email" required id=""
                                                            class="form-control" placeholder="" value="{{$item->email}}" aria-describedby="helpId">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="">twitter</label>
                                                        <input type="text" name="twitter" id=""
                                                            class="form-control" placeholder="" value="{{$item->twitter}}" aria-describedby="helpId">
                                                    </div><br>
                                                    <div class="form-group">
                                                        <label for="">linkedIn</label>
                                                        <input type="text" name="linkedIn" id=""
                                                            class="form-control" placeholder="" value="{{$item->linkedin}}" aria-describedby="helpId">
                                                    </div> <br> <br>
                                                    <div
                                                        class="row ${1| ,row-cols-2,row-cols-3, auto,justify-content-md-center,|}">
                                                        <div class="col  ">
                                                            <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure you want to proceed with the action?')">Register</button>
